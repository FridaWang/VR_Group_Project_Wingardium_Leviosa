...
namespace Valve.VR.InteractionSystem
{
	...
	public class ArrowHand : MonoBehaviour
	{
		...
		private void FireArrow()
		{
			...
			float forceScaler = 2.0f;

			arrow.arrowHeadRB.AddForce( currentArrow.transform.forward * bow.GetArrowVelocity() * forceScaler, ForceMode.VelocityChange );
